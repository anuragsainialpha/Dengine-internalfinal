...
exports.getUpdatedProp = exports.getTransactionData = exports.getTransactionSchema = void 0;
...
function getTrxLineMappedInvParty(LineInvolvedParty, gtmVersion, xmlNs, domain) {
    return (e, i) => (0, transactionProps_1.mapInvolvedParty)(e, LineInvolvedParty, 'Transaction Line : Involved Party', gtmVersion, xmlNs, i, 'Line', domain);
}
function getTrxMappedInvParty(TransactionInvolvedParty, gtmVersion, xmlNs, domain) {
    return (e, i) => (0, transactionProps_1.mapInvolvedParty)(e, TransactionInvolvedParty, 'Transaction : Involved Party', gtmVersion, xmlNs, i, '', domain);
}
function getTrxLineMappedRefnum(LineRefnum, gtmVersion, xmlNs, domain) {
    return (e, i) => (0, transactionProps_1.mapRefnum)(e, LineRefnum, 'Transaction Line : Refnum', gtmVersion, xmlNs, i, 'Line', domain);
}
function getTrxMappedRefnum(TransactionRefnum, gtmVersion, xmlNs, domain) {
    return (e, i) => (0, transactionProps_1.mapRefnum)(e, TransactionRefnum, 'Transaction : Refnum', gtmVersion, xmlNs, i, '', domain);
}
function getTrxLineMappedItemId(ItemGid, gtmVersion, xmlNs, domain) {
    return (e, i) => (0, transactionProps_1.mapTrxLineItemId)(e, ItemGid, 'Transaction Line : Header', gtmVersion, xmlNs, 0, 'Line', domain);
}
function getTrxLineMappedQty(TransactionLineQuantity, gtmVersion, xmlNs, domain, uoms) {
    return (e, i) => (0, transactionProps_1.mapQuantity)(e, TransactionLineQuantity, 'Transaction Line : Quantity', gtmVersion, xmlNs, i, 'Line', domain, uoms);
}
function getTrxLineMappedCur(TransactionLineCurrency, gtmVersion, xmlNs, domain) {
    return (e, i) => (0, transactionProps_1.mapCurrency)(e, TransactionLineCurrency, 'Transaction Line : Currency', gtmVersion, xmlNs, i, 'Line', domain);
}
function getTrxMappedCur(TransactionCurrency, gtmVersion, xmlNs, domain) {
    return (e, i) => (0, transactionProps_1.mapCurrency)(e, TransactionCurrency, 'Transaction : Currency', gtmVersion, xmlNs, i, '', domain);
}
function getTrxMappedQty(TransactionQuantity, gtmVersion, xmlNs, domain, uoms) {
    return (e, i) => (0, transactionProps_1.mapQuantity)(e, TransactionQuantity, 'Transaction : Quantity', gtmVersion, xmlNs, i, '', domain, uoms);
}
function getTrxLineMappedDate(TransLineDate, gtmVersion, xmlNs, domain) {
    return (e, i) => (0, transactionProps_1.mapDate)(e, TransLineDate, 'Transaction Line : Date', gtmVersion, xmlNs, i, 'Line', domain);
}
function getTrxMappedDate(TransDate, gtmVersion, xmlNs, domain) {
    return (e, i) => (0, transactionProps_1.mapDate)(e, TransDate, 'Transaction : Date', gtmVersion, xmlNs, i, '', domain);
}
function getTrxLineMappedRemark(LineRemark, gtmVersion, xmlNs, domain) {
    return (e, i) => (0, transactionProps_1.mapRemark)(e, LineRemark, 'Transaction Line : Remark', gtmVersion, xmlNs, i, 'Line', domain);
}
function getTrxMappedRemark(TransactionRemark, gtmVersion, xmlNs, domain) {
    return (e, i) => (0, transactionProps_1.mapRemark)(e, TransactionRemark, 'Transaction : Remark', gtmVersion, xmlNs, i, '', domain);
}
function getTrxLineMappedHeader(gtmVersion, xmlNs, domain) {
    return (e) => (0, transactionProps_1.mapHeader)(e, 'Transaction Line : Header', gtmVersion, xmlNs, domain);
}
function getTrxMappedHeader(gtmVersion, xmlNs, domain) {
    return (e) => (0, transactionProps_1.mapHeader)(e, 'Transaction : Header', gtmVersion, xmlNs, domain);
}
function _getUpdatedProp(GtmTransaction, transaction, instance, domain) {
    return new Promise(async function (resolve) {
        ...
        if (newPropAddedinGtm.length > 0) {
            const ntransaction = await (0, transaction_1.Transaction)(domain, instance).insertMany(newPropAddedinGtm);
            resolve([...transaction, ...ntransaction]);
        }
        else if (newPropRemovedinGtm.length > 0) {
            await (0, transaction_1.Transaction)(domain, instance).deleteMany({ _id: { $in: [...newPropRemovedinGtm.map((d) => d._id)] } });
...
exports.getTransactionSchema = (0, promise_memoize_1.default)(_getTransactionSchema, { maxAge: 60000 });
exports.getTransactionData = (0, promise_memoize_1.default)(_getTransactionData, { maxAge: 60000 });
