...
const mapHeader = (element, type, gtmVersion, xmlNs, domain) => {
    return {
        name: element.name,
        required: true,
        disabled: (0, renamer_1.getMandatoryElement)(element.name, PARTY_MANDATORY_FIELD),
        display: (0, renamer_1.getMandatoryElement)(element.name, PARTY_MANDATORY_FIELD),
        isMandatory: (0, renamer_1.getMandatoryElement)(element.name, PARTY_MANDATORY_FIELD),
        type: type,
...
const mapAddressLine = (element, AddressLine, type, gtmVersion, xmlNs, i, prefix, domain) => {
    ...
    return {
        ...
        path: [
            ...
            (0, other_1.getSequence)(element, AddressLine[addSequenceIndex].path.replace('INDEX', i), i)
        ],
        gtmVersion,
        xmlNs
    };
};
exports.mapAddressLine = mapAddressLine;
