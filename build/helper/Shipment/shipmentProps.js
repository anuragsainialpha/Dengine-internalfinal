...
const mapHeader = (element, type, gtmVersion, xmlNs, domain) => {
    return {
        name: element.name,
        required: true,
        disabled: (0, renamer_1.getMandatoryElement)(element.name, SHIPMENT_MANDATORY_FIELD),
        display: (0, renamer_1.getMandatoryElement)(element.name, SHIPMENT_MANDATORY_FIELD),
        type: type,
