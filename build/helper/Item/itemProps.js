...
const mapHeader = (element, type, gtmVersion, xmlNs, domain) => {
    return {
        name: element.name,
        required: true,
        disabled: (0, renamer_1.getMandatoryElement)(element.name, ITEM_MANDATORY_FIELD),
        display: (0, renamer_1.getMandatoryElement)(element.name, ITEM_MANDATORY_FIELD),
        isMandatory: (0, renamer_1.getMandatoryElement)(element.name, ITEM_MANDATORY_FIELD),
        type: type,
...
const mapItemFeature = (element, ItemFeature, type, gtmVersion, xmlNs, i, domain) => {
...
const mapRemark = (element, Remark, type, gtmVersion, xmlNs, i, domain) => {
