...
const extract = (path, Parent, child) => {
    ...
    switch (true) {
        ...
        case child === 'ItemFeature':
            newPath = (0, other_1.convertPath)(path, 'ItemFeature').newPath;
            newName = (0, other_1.convertPath)(path, 'ItemFeature').newName;
            break;
        case child === 'GtmItemClassification':
            newPath = (0, other_1.convertPath)(path, 'GtmItemClassification').newPath;
            newName = (0, other_1.convertPath)(path, 'GtmItemClassification').newName;
            break;
        case child === 'GtmItemDescription':
            newPath = (0, other_1.convertPath)(path, 'GtmItemDescription').newPath;
            newName = (0, other_1.convertPath)(path, 'GtmItemDescription').newName;
            break;
        case child === 'GtmItemCountryOfOrigin':
            newPath = (0, other_1.convertPath)(path, 'GtmItemCountryOfOrigin').newPath;
            newName = (0, other_1.convertPath)(path, 'GtmItemCountryOfOrigin').newName;
            break;
        case child === 'GtmItemUomConversion':
            newPath = (0, other_1.convertPath)(path, 'GtmItemUomConversion').newPath;
            newName = (0, other_1.convertPath)(path, 'GtmItemUomConversion').newName;
            break;
        default:
            break;
    }
