...
const getMandatoryElement = (name, mandatoryList = []) => mandatoryList.findIndex(d => d === name) > -1;
exports.getMandatoryElement = getMandatoryElement;
const getDefaultValue = (path, domain) => {
