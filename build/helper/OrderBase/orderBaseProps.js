...
const mapHeader = (element, type, gtmVersion, xmlNs, domain) => {
    return {
        name: element.name,
        required: true,
        disabled: (0, renamer_1.getMandatoryElement)(element.name, ORDERBASE_MANDATORY_FIELD),
        display: (0, renamer_1.getMandatoryElement)(element.name, ORDERBASE_MANDATORY_FIELD),
        isMandatory: (0, renamer_1.getMandatoryElement)(element.name, ORDERBASE_MANDATORY_FIELD),
        type: type,
...
const mapRefnum = (element, Refnum, type, gtmVersion, xmlNs, i, prefix, domain) => {
...
const mapRemark = (element, Remark, type, gtmVersion, xmlNs, i, prefix, domain) => {
    ...
    return {
        ...
        defaultValue: (0, renamer_1.getDefaultValue)(Remark[remTextIndex].path, domain),
        path: [
            { path: Remark[remTextIndex].path.replace('INDEX', i), value: '' },
            (0, other_1.getTC)(element, Remark[remTransactionCodeIndex].path.replace('INDEX', i)),
            (0, other_1.getSequence)(element, Remark[remSequenceIndex].path.replace('INDEX', i), i),
            (0, other_1.getDomainName)(element, Remark[remDomainNameIndex].path.replace('INDEX', i)),
            (0, other_1.getXID)(element, Remark[remIdIndex].path.replace('INDEX', i))
        ],
        gtmVersion,
        xmlNs
    };
};
exports.mapRemark = mapRemark;
const mapItemFeature = (element, ItemFeature, type, gtmVersion, xmlNs, i, prefix, domain) => {
    ...
    return {
        ...
        defaultValue: (0, renamer_1.getDefaultValue)(ItemFeature[fetValueIndex].path, domain),
        path: [
            { path: ItemFeature[fetValueIndex].path, value: '' },
            (0, other_1.getDomainName)(element, ItemFeature[fetDomainNameIndex].path),
            (0, other_1.getTC)(element, ItemFeature[remTransactionCodeIndex].path),
            (0, other_1.getXID)(element, ItemFeature[fetIdIndex].path)
        ],
        gtmVersion,
        xmlNs
    };
};
exports.mapItemFeature = mapItemFeature;
const mapItemClassification = (element, ItemClassification, type, gtmVersion, xmlNs, i, domain) => {
    ...
    return {
        ...
        defaultValue: (0, renamer_1.getDefaultValue)(ItemClassification[fetValueIndex].path, domain),
        path: [
            { path: ItemClassification[fetValueIndex].path, value: '' },
            (0, other_1.getTC)(element, ItemClassification[remTransactionCodeIndex].path),
            (0, other_1.getXID)(element, ItemClassification[fetIdIndex].path)
        ],
        gtmVersion,
        xmlNs
    };
};
exports.mapItemClassification = mapItemClassification;
const mapInvolvedParty = (element, InvolvedParty, type, gtmVersion, xmlNs, i, prefix, domain = '') => {
    ...
    return {
        ...
        defaultValue: (0, renamer_1.getDefaultValue)(InvolvedParty[remTextIndex].path, domain),
        path: [
            { path: InvolvedParty[remTextIndex].path, value: '' },
            (0, other_1.getTC)(element, InvolvedParty[remTransactionCodeIndex].path),
            { path: InvolvedParty[remTextIndexDomain].path, value: domain },
            (0, other_1.getXID)(element, InvolvedParty[remIdIndex].path)
        ],
        gtmVersion,
        xmlNs
    };
};
exports.mapInvolvedParty = mapInvolvedParty;
const mapItemDescription = (element, ItemDescription, type, gtmVersion, xmlNs, i, domain) => {
    ...
    return {
        ...
        defaultValue: (0, renamer_1.getDefaultValue)(ItemDescription[remTextIndex].path, domain),
        path: [
            { path: ItemDescription[remTextIndex].path, value: '' },
            (0, other_1.getTC)(element.split('::')[0], ItemDescription[remTransactionCodeIndex].path),
            (0, other_1.getSequence)(element.split('::')[0], ItemDescription[remSequenceIndex].path, i),
            (0, other_1.getDomainName)(element.split('::')[0], ItemDescription[remDomainNameIndex].path),
            (0, other_1.getXID)(element.split('::')[0], ItemDescription[remIdIndex].path)
        ],
        gtmVersion,
        xmlNs
    };
};
exports.mapItemDescription = mapItemDescription;
